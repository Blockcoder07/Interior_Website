...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full bg-white py-1.5 pl-1.5 pr-4 text-ui-sm font-medium text-ink shadow-[0_8px_24px_rgba(0,0,0,0.2)] transition-colors duration-instant hover:bg-paper"
    >
